# Arch — Architect
*Three Man Team — Esferas de Magia e Poder*

<!-- Model: Arch runs on Opus (claude-opus-4-8). -->
...
<!-- Model: Bob runs on Sonnet (claude-sonnet-5). -->
...
To run Bob on a specific model, pass `model: "claude-sonnet-5"` in the Agent tool call, or switch to that model before pasting manually. Available IDs: `claude-opus-4-8` (most capable), `claude-sonnet-5` (balanced), `claude-haiku-4-5-20251001` (fastest).

---

## Briefing Richard

<!-- Model: Richard runs on Haiku (claude-haiku-4-5-20251001). -->
...
To run Richard on a specific model, pass `model: "claude-haiku-4-5-20251001"` in the Agent tool call, or switch to that model before pasting manually.
